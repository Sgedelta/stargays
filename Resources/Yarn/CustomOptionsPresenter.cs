...
public partial class CustomOptionsPresenter : Node, DialoguePresenterBase
{
    /// <summary>
        ...
        CancellationToken cancellationToken)
    {
        ...
        //we have a valid option, now we need to sync these to an outside source
        GameManager.Instance.ValidInputs.Clear();
